...
Revision ID: 9902c13e939c
Revises: 
Create Date: 2024-04-03 10:33:26.477874
...
def upgrade() -> None:
    ...
    op.create_table('agent_installation_method',
    ...
    op.create_table('agent_association_table',
    sa.Column('agent_id', sa.Integer(), nullable=True),
    sa.Column('run_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['agent_id'], ['agent.id'], ),
    sa.ForeignKeyConstraint(['run_id'], ['run.id'], )
    )
    op.create_table('agent_git_install',
    ...
    sa.ForeignKeyConstraint(['id'], ['agent_installation_method.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('agent_local_install',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('agent_instances', sa.String(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['run_id'], ['run.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('agent_local_install')
    op.drop_table('agent_git_install')
    op.drop_table('agent_association_table')
    op.drop_table('run')
    op.drop_table('agent_installation_method')
