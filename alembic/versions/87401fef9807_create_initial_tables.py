...
Revision ID: 87401fef9807
Revises: 
Create Date: 2025-01-03 15:07:33.016527
...
def upgrade() -> None:
    ...
    sa.Column('data', sqlalchemy_utils.types.scalar_list.ScalarListType(), nullable=False),
    ...
    sa.Column('variable_override', sqlalchemy_utils.types.json.JSONType(), nullable=False),
    ...
    op.create_table('images_services',
    ...
    op.create_table('service_container',
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['dependant_service_id'], ['service_container.id'], ),
    sa.ForeignKeyConstraint(['dependency_service_id'], ['service_container.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('services_volumes',
    sa.Column('service_container_id', sa.Integer(), nullable=False),
    sa.Column('volume_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['service_container_id'], ['service_container.id'], ),
    sa.ForeignKeyConstraint(['volume_id'], ['volume.id'], ),
    sa.PrimaryKeyConstraint('service_container_id', 'volume_id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('service_container')
