...
from typing import Literal, TypedDict, overload, type_check_only, Any
...
class ContainerApiMixin:
    ...
    def create_networking_config(self, *args: Any, **kwargs: Any) -> NetworkingConfig: ...
    def create_endpoint_config(self, *args: Any, **kwargs: Any) -> EndpointConfig: ...
    ...
    def inspect_container(self, container: _Container) -> dict[str, Any]: ...
