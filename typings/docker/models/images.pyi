...
from typing import IO, Any, Literal, TypedDict, overload, type_check_only, Any
...
class Image(Model):
    ...
    def tag(self, repository: str, tag: str | None = None, **kwargs: Any) -> bool: ...
...
class ImageCollection(Collection[Image]):
    ...
    def push(self, repository: str, tag: str | None = None, **kwargs: Any): ...
